  ...
  <view>
    ...
    <view class="margin-xl bg-white padding-xl radius shadow-lg">
      ...
      <view class="text-content">
        <view>Hi！您好，开发者～ 欢迎使用 Uni App Admin 移动端跨平台模板！</view>
        <view class="margin-top-sm"
          >该模版为 Uni App Admin Lite 精简版，您可直接用于开发，若您想要查看完整版，请访问
          <u-tag
            text="Github"
            mode="light"
            size="mini"
        ...
        >
        <view class="margin-top-sm"
          >该项目是完全开源的，不收取任何费用。如果这个项目有帮到您，或者您觉得很 🎉 ！您可以在
          <u-tag
            text="Github"
            mode="light"
            size="mini"
